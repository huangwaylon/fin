...
export function valuation(ex, opts = {}) {
  ...
  return {
    ...
    // Value creation: does the business earn above its cost of capital? Positive
    // ROIC−WACC spread is the core durability test for a multi-year holder.
    roic: isNum(ex.roic) ? ex.roic : null,
    wacc: discount,
    valueCreationSpread: isNum(ex.roic) ? ex.roic - discount : null,
    sensitivity,
  };
}
